...
import { AlertTriangle, X, File, Trash2, Maximize2, RotateCcw, Save, Download, Music, Menu, SquarePen, Eye, MessageCircle, Check } from 'lucide-react';
            ...
            {!fileContent?.isBinary && !fileContent?.isImage && (
              editing
                ...
                : isHtml && htmlTab === 'preview'
                  ...
                  : isMarkdown
                  ? <DocCommentedMarkdown scope={project.id} docPath={filePath} content={content} isMobile={isMobile} onCounts={onCommentCounts} />
                  : <SyntaxHighlighter

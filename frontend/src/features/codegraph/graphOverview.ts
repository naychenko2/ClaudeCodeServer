...
//
// Слои — ФИКСИРОВАННЫЙ маппинг по именам неймспейсов (Tests → Controllers/Hubs →
...
// и без приоритета осели бы в слое Controllers.
...
export const LAYER_TITLES = ['Тесты', 'Controllers / Hubs', 'Services', 'Models / Protocol', 'Прочее'];

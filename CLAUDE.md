...
карточки — место `chat-digest` по пункту меню карточки (подвала у архивной карточки нет:
она обычная, действия — в контекстном меню), кэш инвалидируется активностью. Автоправило

// Клиентское правило «у какой ссылки есть кнопка-компаньон» — ADR-005 §2/§3.
// Это UX-фильтр (спрятать заведомо бесполезную/локальную кнопку), а не защита: реальный
// SSRF-периметр — на сервере (SsrfGuard + перепроверка на каждом хопе редиректа). Клику
// по самой ссылке эти правила не мешают — она как обычно ведёт в новую вкладку.

...
// Коллекция процесс-глобального состояния — общая с DockerProcessRunnerEnvTests: оба
// манипулируют process-global Environment.SetEnvironmentVariable, xunit не должен гонять
// их параллельно (флаки).

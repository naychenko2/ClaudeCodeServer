...
|---|---|---|
| ClaudeCodeServer — операционка | `llm-operations.json` | Живость сервера, скорость и отказы ходов LLM, вызовы MCP, сессии и соединения |
...
> останется висеть. Старый после переименования надо удалить руками (в UI или

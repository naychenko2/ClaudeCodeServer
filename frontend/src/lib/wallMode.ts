...
// (клик по подсвеченной пилюле «Проекты» прямо со стены). WALL_RETURN_KEY —
// режим зоны проектов в момент ухода из неё в другой раздел (стена/воркспейс/список): клик «Проекты» из

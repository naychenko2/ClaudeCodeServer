...
//
// ФАЙЛ ЗАМОРОЖЕН (ADR-012): это путь отката на рубильнике Mcp:HttpTransport, а не
// источник контракта. Схема, лимиты (64 КБ / 120 символов / 120..1200) и тексты
// widget_show ведутся в WidgetsToolset.cs и проверяются на парность сторожем
// WidgetsToolsetParityTests — правь контракт ТАМ, иначе тест упадёт.
//
// Известное допустимое расхождение с http-веткой: дефолт protocolVersion при пустых
// params здесь 2024-11-05, в WidgetsToolset.cs — 2025-06-18. На поведение не влияет
// (CLI всегда присылает свою версию, мы отвечаем эхом).
//

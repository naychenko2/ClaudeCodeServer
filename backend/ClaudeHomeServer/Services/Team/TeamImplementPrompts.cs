...
public static class TeamImplementPrompts
{
    ...
    public static string BlockerReactionTurn(string? childChatName, string? childChatId) =>
        ...
        "маркера эскалации ставить не нужно. Если снять блокер не выходит — поставь маркер " +
        "эскалации (<escalate:check> или <escalate:deviation>), тогда карточка останется человеку.";

...
// TurnRunPassport и сводка (TurnRunSummary/TurnOutcomeStat/TurnErrorClassStat) переехали
// в Core (`Core/Services/Llm/TurnRunPassport.cs`, этап 5, шаг 2) — для разрыва цикла
// Llm ⇄ Turn через шину событий хода (TurnCompleted в Services/Turn/TurnEvents.cs).
...
// Сводные типы (TurnRunSummary/TurnOutcomeStat/TurnErrorClassStat) переехали
// в Core вместе с TurnRunPassport (см. Core/Services/Llm/TurnRunPassport.cs).

...
**Масштаб ограничения в этой волне:** за волну 4 руками объявлено больше
двух десятков швов из тел методов, найденных только ручным IL-сканом
(не «что-то встретилось», а каждый шов — это инцидент вида «сторож молчит,

...
// Потолки подняты на два пункта: пункт меню ~34px (строка 13.5px + отступы 9px сверху
// и снизу), поэтому оба потолка выросли на 68px — видимых фраз стало на две больше
const MENU_MAX_H = 428;
const MENU_LIST_MAX_H = 328;

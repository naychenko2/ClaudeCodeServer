...
public static class FeatureFlagCatalog
{
    ...
    [
        ...
        new FeatureFlagDefinition(
            ...
            Title: "История решений в подсказках персонам",
            Description: "Персоны будут видеть историю решений по коду, который правят, — и не станут повторно предлагать то, что уже отвергли. Включайте, когда убедитесь, что записи получаются толковыми.",
            Default: false,
            Stage: "dev"),
    ];

...
export function AiLauncher() {
  ...
  // Объявлено ДО эффекта сброса ниже: он зовёт setRecs, а обращение к переменной выше её
  // объявления не даёт эффекту подхватывать изменения значения (react-hooks/immutability).

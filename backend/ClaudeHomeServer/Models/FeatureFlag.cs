...
public static class FeatureFlagCatalog
{
    ...
    [
        ...
        new FeatureFlagDefinition(
            ...
            Description: "Поиск MCP-серверов по открытому реестру сообщества с автоподстановкой команды, адреса и имён ключей в форму заведения. AI Home не проверяет код этих серверов — смотрите, кто автор.",
            Default: false,
            Stage: "dev"),
    ];

...
public static class FeatureFlagKeys
{
    ...
    // Уборка карты проекта (CLAUDE.md), фронтовая часть: аккордеон «Проверить карту
    // проекта» в настройках проекта + модалка с фактами сканера. Под флагом же
...
public static class FeatureFlagCatalog
{
    ...
    [
        ...
        new FeatureFlagDefinition(
            ...
            Default: false,
            Stage: "dev"),
        // Уборка карты проекта (docs/research/project-map-hygiene-plan-2026-09.md):
        // секция «Проверить карту проекта» в настройках проекта с модалкой фактов
        // скана. На обороте того же флага сервер гасит review и apply — пока фича
        // выключена, никто не сможет ни получить формулировки модели, ни применить
        // правку к файлу. Тексты — дословно из таблицы Майи в плане.
        new FeatureFlagDefinition(
        ...
        // Включён всем по умолчанию; выключить себе можно override'ом в «Экспериментальных функциях».
        new FeatureFlagDefinition(

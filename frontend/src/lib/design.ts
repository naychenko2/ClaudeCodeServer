...
export const C = {
  ...
  glass:       'var(--c-glass)',
  mediaScrim:  'var(--c-media-scrim)',  // плашка поверх чужой картинки; от темы не зависит
  mediaBackdrop: 'var(--c-media-backdrop)',  // поля вокруг кадра; от темы не зависит
...
// === Дорожка-«волна» записи голоса ===
// Задержки анимации 12 столбиков (класс .cc-wave-bar, keyframes cc-wave в index.css):
// рассинхрон, чтобы полоски не ходили в фазу. Одна точка на композер и карточки чата —
// разъехавшиеся копии выглядели бы как две разные индикации записи.
export const WAVE_BAR_DELAYS = [0.0, 0.12, 0.28, 0.45, 0.6, 0.32, 0.15, 0.5, 0.05, 0.36, 0.18, 0.42]

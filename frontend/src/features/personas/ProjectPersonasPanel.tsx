      ...
      <div style={{ flex: 1, minHeight: 0 }}>
        {persona ? (
          ...
          <PersonaForm
            ...
            initial={template ? { role: template.role, description: template.description, contract: template.contract, greeting: template.greeting, color: template.avatarColor, tools: template.tools, access: template.access } : undefined}
            onStatus={onStatus}
            onColorChange={setLiveColor}

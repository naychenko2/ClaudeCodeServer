...
// Молчаливых пауз не бывает. См. docs/features/team-implement-mode.md, «Эскалация и остановки».
public enum TeamEscalationKind
{
    ...
    CheckFailed,
    // Нужно продуктовое решение: два рабочих варианта (маркер координатора)
    ProductDecision,

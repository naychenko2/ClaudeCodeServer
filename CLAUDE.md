...
`chat-auto-archive` (автоправило архива чатов; ручной архив и режим «Архивные» в списке
чатов — отдельного раздела нет — работают без флага — см. раздел «Архив чатов»).

...
// backend/ClaudeHomeServer/Services/Mcp/Http/NotesToolset.cs; правки схем/поведения
// обязаны ехать парой с http-веткой (сторож парности — NotesToolsetParityTests).
// Файл не удалять: Mcp:HttpTransport=false возвращает notes на stdio с этим env.
//

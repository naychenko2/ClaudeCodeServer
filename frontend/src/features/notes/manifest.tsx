// Чистый экспорт манифеста подсистемы «Заметки» (SubsystemManifest).
// Вынесен из registry.tsx, чтобы Module Federation remote мог экспортировать его
// без side-effect регистрации. registry.tsx по-прежнему вызывает registerSubsystem.

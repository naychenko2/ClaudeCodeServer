 ...
 *
 * Рендерится в App — НАД страницами, а не внутри них. Поэтому единственный режим,
 * который переживает переход между проектами и разделами: кадр не размонтируется,
 * эфир не начинается заново. Панель и центр так не умеют — они часть страницы.
 *

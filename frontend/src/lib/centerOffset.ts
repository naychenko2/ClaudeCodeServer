...
// вместе со своей обвязкой (у чата это CHAT_COLUMN_W: колонка чтения + место под
// полосу прокрутки и равный ему отступ слева, а не голый CHAT_MAX_W). Занизишь — хук сочтёт чужое

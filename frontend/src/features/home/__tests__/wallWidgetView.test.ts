...
describe('точка статуса строки', () => {
  ...
  it('живой фон (агенты или команда) даёт точку работы, а не серую непрочитанность', () => {
    // Статус чата при доживающем фоне — active: без признака строка получала бы
    // серую точку «сюда не заходили», хотя работа идёт прямо сейчас. Вид фона тут
    // не различаем — вызывающий передаёт объединение (bgWork)

...
(2026-08); в каталоге **три флага**: `workspace-destructive` (постоянный предохранитель от
...
и `desktop-agent` (руки на машине пользователя: тип чата «Десктопный», тумблер грани в
проекте, канал устройств — см. раздел «Десктопный агент»).

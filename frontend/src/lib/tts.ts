...
export function sanitizeForSpeech(md: string): string {
  ...
  // Селектор варианта U+FE0F стоит в классе НАМЕРЕННО и режется отдельно от своей базы:
  // задача — вычистить и сам знак, и хвост-селектор, а не сохранить графемный кластер

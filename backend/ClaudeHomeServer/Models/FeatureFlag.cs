...
public static class FeatureFlagCatalog
{
    ...
    [
        ...
        new FeatureFlagDefinition(
            ...
            Description: "Поиск MCP-серверов по открытому реестру сообщества: команда, адрес и имена ключей подставятся в форму сами — вам останется вписать свой ключ. AI Home не проверяет код этих серверов, смотрите, кто автор.",
            Default: false,
            Stage: "dev"),
    ];

...
// склонений в кодовой базе нет: та же копия живёт в useMcpData и lib/plural,
// локальная копия на модуль — действующая конвенция;
// (lib/plural.ts появился при расколе F1.2)

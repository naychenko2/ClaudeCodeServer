...
(2026-08); в каталоге **шесть флагов**: `workspace-destructive` (постоянный предохранитель от
...
«Архив чатов») и `mcp-catalog` (поиск MCP-серверов по официальному реестру и
предзаполнение формы — см. раздел «Личный реестр MCP-серверов»).

...
// Блок «сохранность Display» снят: он проверял withDisplay/withoutDisplay из
// lib/specialties и экран SpecialtyEditView, которых в master нет — механика
// пользовательских подписей ролей сюда не доехала, а тесты приехали из ветки и
// лежали красными. Вернётся вместе с самой фичей.

...
public class Session
{
    ...
    // Второй инвариант — межпровайдерного фолбэка у такого чата нет: цепочка хода режется
    // до пула Claude в FallbackLlmSessionAdapter (TrimChainForDesktop), иначе транскрипт
    // с кадрами штатно уезжает стороннему вендору.

...
переноса доказывается пробной сборкой, а не чтением кода — подробности и разбор
трёх промахов оценки в [ADR-014](docs/adr/ADR-014-internal-subsystems.md). Сторожа границ
